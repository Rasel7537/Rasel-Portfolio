  ...
  const projects = [
    {
      ...
      images: [
        "https://via.placeholder.com/800x450.png?text=Task+App+1",
        "https://via.placeholder.com/800x450.png?text=Task+App+2",
        "https://via.placeholder.com/800x450.png?text=Task+App+3",
      ],
      live: "#",
      github: "#",
  ...
  return (
    <div className="min-h-screen bg-black text-white py-16 px-6 flex flex-col items-center justify-center">
      ...
      <motion.h2
        ...
        className="text-4xl md:text-5xl font-extrabold mb-12 text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-center"
      >
        My Projects
      </motion.h2>
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="w-full lg:w-1/2 space-y-4 text-center lg:text-left">
              <h3 className="text-3xl font-bold text-purple-400">{project.name}</h3>
