...
//         <h1 className="text-5xl font-extrabold mb-3 text-transparent  bg-gradient-to-r from-cyan-400 via-green-400 to-blue-500 bg-clip-text">
...
//         className="flex flex-col md:flex-row max-w-5xl mx-auto p-8 bg-black rounded-xl shadow-2xl border border-purple-500" // ফর্ম/অ্যানিমেশন এর ব্যাকগ্রাউন্ড ডার্ক গ্রে
//       >
